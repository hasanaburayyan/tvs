...
namespace SpacetimeDB.Types
{
	...
	public sealed partial class RemoteTables : RemoteTablesBase
	{
		public RemoteTables(DbConnection conn)
		{
			...
			AddTable(MapCapturePointDef = new(conn));
			AddTable(MapDef = new(conn));
			AddTable(MapTerrainDef = new(conn));
	...
	public sealed class QueryBuilder
	{
		...
		internal static string[] AllTablesSqlQueries() => new string[]
		{
			...
			new QueryBuilder().From.MapCapturePointDef().ToSql(),
			new QueryBuilder().From.MapDef().ToSql(),
			new QueryBuilder().From.MapTerrainDef().ToSql(),
	...
	public sealed class From
	{
		...
		public global::SpacetimeDB.Table<MapCapturePointDef, MapCapturePointDefCols, MapCapturePointDefIxCols> MapCapturePointDef() => new("map_capture_point_def", new MapCapturePointDefCols("map_capture_point_def"), new MapCapturePointDefIxCols("map_capture_point_def"));
		...
		public global::SpacetimeDB.Table<MapTerrainDef, MapTerrainDefCols, MapTerrainDefIxCols> MapTerrainDef() => new("map_terrain_def", new MapTerrainDefCols("map_terrain_def"), new MapTerrainDefIxCols("map_terrain_def"));
		...
		public global::SpacetimeDB.Table<Targetable, TargetableCols, TargetableIxCols> Targetable() => new("targetable", new TargetableCols("targetable"), new TargetableIxCols("targetable"));
		...
		public global::SpacetimeDB.Table<WeaponState, WeaponStateCols, WeaponStateIxCols> WeaponState() => new("weapon_state", new WeaponStateCols("weapon_state"), new WeaponStateIxCols("weapon_state"));
	}
	...
	public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
	{
		...
		protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
		{
			...
			return reducer switch
			{
				...
				Reducer.ReportProjectileHit args => Reducers.InvokeReportProjectileHit(eventContext, args),
